			...
			<div class="flex-w flex-sb-m p-b-52">
				...
				<div class="dis-none panel-search w-full p-t-10 p-b-15">
					<div class="bor8 dis-flex p-l-15">
						...
						<input class="mtext-107 cl2 size-114 plh2 p-r-15" type="text" name="search-product" placeholder="Pesquisar">
					</div>	
				</div>
			</div>
		...
		document.addEventListener('DOMContentLoaded', function () {
			...
			btnAddCart.addEventListener('click', function () {
				...
				if (isNaN(parseFloat(quantidade)) || !isFinite(quantidade) || quantidade <= 0) {
					...
					swal(nome, 'Erro ao adicionar o produto no carrinho.', '', 'error');
					return;
				}
