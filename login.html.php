			...
			<div class="size-110 bor10 p-lr-20 p-t-55 p-b-70 p-lr-15-lg w-full-md">
				<form action="login.php" method="post" style="display: block">
					<section class="bg-img1 txt-center p-lr-15 p-t-10 p-b-22">
						<h2 class="ltext-105 cl0 txt-center" style="color: gray" style="margin-bottom: 1.5%;">
							INICIAR SESSÃO
						</h2>
					</section>	
					...
					<div class="row p-b-25">
						<div class="col-sm-6 p-b-5">
							...
							<input class="size-111 bor8 stext-102 cl2 p-lr-20" type="text" placeholder="Email" name="email" required>
						</div>
						<div class="col-sm-6 p-b-5">
							<label class="stext-102 cl3" for="senha">SENHA</label>
							<input class="size-111 bor8 stext-102 cl2 p-lr-20" type="password" placeholder="Senha" name="senha" required>
						</div>
					</div>

					<input class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer" style="margin-bottom: 1.5%;" type="submit" value="Entrar"></input>
				</form>

                <a class="stext-110 cl2" href="cadastro.php">
